...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-08-2026 a las 17:51:09
...
INSERT INTO `asistencias` (`id_asistencia`, `id_grupos`, `dni_promotoras`, `hora_presente`, `fecha`) VALUES
(5, 33, 12312, 2147483647, '2026-08-13');
...
ALTER TABLE `asistencias`
  ...
  ADD UNIQUE KEY `id_grupos` (`id_grupos`,`dni_promotoras`),
...
--
ALTER TABLE `grupos`
  MODIFY `id_grupos` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;

--
-- AUTO_INCREMENT de la tabla `grupos_fechas`
--
ALTER TABLE `grupos_fechas`
  MODIFY `id_grupos_fechas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT de la tabla `grupos_promotoras`
--
ALTER TABLE `grupos_promotoras`
  MODIFY `id_grupo_promotas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
...
--
ALTER TABLE `asistencias`
  ADD CONSTRAINT `asistencias_ibfk_1` FOREIGN KEY (`id_grupos`) REFERENCES `grupos` (`id_grupos`),
  ADD CONSTRAINT `asistencias_ibfk_2` FOREIGN KEY (`dni_promotoras`) REFERENCES `promotoras` (`dni_promotoras`);
